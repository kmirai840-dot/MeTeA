...
class ResponsiveScheduleTest(unittest.TestCase):
    def test_all_dates_states_order_and_safe_actions(self):
        rows = [ApplicationMilestone(id=1,title='完了済み',status='completed',scheduled_date='2026-09-10'),
        ...
        for text in ('日程未定','2026/9/16（水）','あと3日','期限超過・1日経過','完了','&lt;会社&gt;','&lt;未完了&gt;', 'data-schedule-application="9"','application_id=9'):
